...
![Figure 6: 5 Epoch CNN Run](Results/cnn_epoch_5.png)

![Figure 7: 10 Epoch CNN Run](Results/cnn_epoch_10.png)
...
![Figure 8: Dense Network Results](Results/dense_epoch_10.png)
...
![Figure 9: Deer Picture Used in Model Testing](Testing/deer_sample_img.png)

From this the model was correctly able to guess that this picture was in fact a picture of a deer. 

![Figure 10: Results from Testing](Testing/screenshot_of_test.png)
